...
class App(QMainWindow, QWidget):  # 창의 대부분의 기능
    ...
    def sizeDesFile(self):
        self.size_des_generateView(self.read_FAT_DATA.get_content(self.read_cluster), self.read_cluster)

    def createAscFile(self):
        self.create_asc_generateView(self.read_FAT_DATA.get_content(self.read_cluster), self.read_cluster)

    def createDesFile(self):
        self.create_des_generateView(self.read_FAT_DATA.get_content(self.read_cluster), self.read_cluster)

    def writeAscFile(self):
        self.write_asc_generateView(self.read_FAT_DATA.get_content(self.read_cluster), self.read_cluster)

    def writeDesFile(self):
        self.write_des_generateView(self.read_FAT_DATA.get_content(self.read_cluster), self.read_cluster)
    ...
    def size_asc_generateView(self, text,cluster):
        self.read_FAT_DATA.renew_list()
        space = ' '
        rowSpacing = 4  # How many bytes before a double space.
        rowLength = 16  # 헥사 창에 얼마나 많은 byte 가 들어갈 것인지
    ...
    def write_des_generateView(self, text, cluster):
        ...
        self.file_button_list_area.setAlignment(Qt.AlignTop)
        self.Imagelb.setPixmap(self.asciiImageArea)
    def write_asc_generateView(self, text,cluster):
        self.read_FAT_DATA.renew_list()
        space = ' '
        rowSpacing = 4  # How many bytes before a double space.
        rowLength = 16  # 헥사 창에 얼마나 많은 byte 가 들어갈 것인지
        ...
        self.file_button_list_area.setAlignment(Qt.AlignTop)
        self.Imagelb.setPixmap(self.asciiImageArea)
    def create_des_generateView(self, text, cluster):
        self.read_FAT_DATA.renew_list()
        space = ' '
        rowSpacing = 4  # How many bytes before a double space.
        rowLength = 16  # 헥사 창에 얼마나 많은 byte 가 들어갈 것인지
        ...
        self.file_button_list_area.setAlignment(Qt.AlignTop)
        self.Imagelb.setPixmap(self.asciiImageArea)
    def create_asc_generateView(self, text,cluster):
        self.read_FAT_DATA.renew_list()
        space = ' '
        rowSpacing = 4  # How many bytes before a double space.
        rowLength = 16  # 헥사 창에 얼마나 많은 byte 가 들어갈 것인지
