...
class App(QMainWindow, QWidget):  # 창의 대부분의 기능
    def __init__(self):  # 창 기본 세팅 설정
        ...
        self.initUI()
        self.readFile('C:/Users/ASUS/Desktop/3-2/종프/fat32/fat32.dd')
    ...
    def generateView(self, text):
        ...
        for i in range(len(self.btn_list(button_data))):
            self.button_list_area.addWidget(self.btn_list(button_data)[i])
    ...
    def button_on_clicked(self, index):
            ...
            self.read_FAT_DATA.get_files(self.read_FAT_DATA.dir_list[index]['cluster'])
